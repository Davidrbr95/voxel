...
class Stage(BaseStage):
    ...
    def set_default_z_motion_asi_parameters(self):
        self.ms2000.set_default_z_motion_asi_parameters()
    ...
    def ring_buffer_load_position(self, axis1: str, axis2: str, position_mm: float) -> None:
        ...
        :param position_mm: stage position in millimeters.
        """
        self.ms2000.ring_buffer_load_position(axis1, axis2, position_mm)
